...
<form method="POST" action="{{ route('professionalDevelopmentPrograms.update', $program) }}">
    @csrf
    @method('put')
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" autofocus value="{{ $program->name }}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="date_approval_faculty" type="date" class="form-control @error('date_approval_faculty') is-invalid @enderror" name="date_approval_faculty" value="{{ $program->date_approval_faculty }}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="date_approval_council" type="date" class="form-control @error('date_approval_council') is-invalid @enderror" name="date_approval_council" value="{{ $program->date_approval_council }}">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            <input id="date_approval_rector" type="date" class="form-control @error('date_approval_rector') is-invalid @enderror" name="date_approval_rector" value="{{ $program->date_approval_rector }}">
